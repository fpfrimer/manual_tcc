...
\newcommand{\startdate}{24/03/2024}		% Data de início do semestre
\newcommand{\agendadate}{18/06/2025}	% Prazo para desenvolvimento e escrita do TCC
\newcommand{\bancadate}{28/06/2025}		% Prazo para realização das Bancas
\newcommand{\finaldate}{05/07/2025}		% Prazo para a entrega da versão final
\newcommand{\seiprocess}{23064.010063/2025-91} % Processo para as ATAs
