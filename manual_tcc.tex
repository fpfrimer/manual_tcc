...
\newcommand{\startdate}{02/03/2023}		% Data de início do semestre
\newcommand{\agendadate}{07/06/2023}	% Prazo para agendamento da banca de TCC
\newcommand{\bancadate}{28/06/2023}		% Prazo para realização das Bancas
\newcommand{\finaldate}{01/07/2023}		% Prazo para a entrega da versão final
